  ...
  const config = {
    modified: {
      ...
      className:
        ...
        'dark:bg-amber-900/40 dark:text-amber-100 dark:border-amber-500/40',
      icon: (
        <svg
          className="w-3 h-3"
          fill="none"
    ...
    identical: {
      ...
      className:
        ...
        'dark:bg-emerald-900/40 dark:text-emerald-100 dark:border-emerald-500/40',
      icon: (
        <svg
          className="w-3 h-3"
          fill="none"
    ...
    added: {
      ...
      className:
        ...
        'dark:bg-purple-900/40 dark:text-purple-100 dark:border-purple-500/40',
      icon: (
        <svg
          className="w-3 h-3"
          fill="none"
    ...
    missing_new: {
      ...
      className:
        ...
        'dark:bg-red-900/40 dark:text-red-100 dark:border-red-500/40',
      icon: (
        <svg
          className="w-3 h-3"
          fill="none"
...
function ActionButton({
  ...
  const variantClasses =
    variant === 'primary'
      ? 'btn-primary'
      : 'inline-flex items-center justify-center rounded-md px-3 py-2.5 text-sm font-medium bg-white text-purple-700 border border-purple-200 hover:bg-purple-50 dark:bg-slate-900 dark:text-purple-200 dark:border-purple-500/40 dark:hover:bg-slate-800';
...
// Stats Card Component – light/dark aware
function StatsCard({ icon, label, value, color = 'purple' }) {
  const colors = {
    purple:
      'bg-purple-50 border-purple-200 text-purple-800 ' +
      'dark:bg-purple-900/40 dark:border-purple-500/40 dark:text-purple-100',
    green:
      'bg-emerald-50 border-emerald-200 text-emerald-800 ' +
      'dark:bg-emerald-900/40 dark:border-emerald-500/40 dark:text-emerald-100',
    amber:
      'bg-amber-50 border-amber-200 text-amber-800 ' +
      'dark:bg-amber-900/40 dark:border-amber-500/40 dark:text-amber-100',
  };
  ...
  return (
    ...
    >
      <div className="p-1.5 rounded-md bg-white text-slate-700 dark:bg-slate-900 dark:text-slate-100">
        {icon}
      </div>
      <div>
...
const handleCaptureAllConfigs = async () => {
  ...
  return (
    <>
      ...
      {/* page root: full height from <main>, allow children to shrink */}
      <div className="h-full px-4 py-4 md:px-6 md:py-6 bg-slate-100 dark:bg-slate-900">
        {/* main card: flex column, can shrink */}
        <div className="glass-panel h-full flex flex-col gap-4 px-4 py-3 md:px-5 md:py-4 min-h-0">
          {/* Header Card */}
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 flex-1 min-w-0">
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-md bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-100">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <div className="flex flex-wrap items-center gap-2 justify-end">
                ...
                <div className="hidden sm:block h-6 w-px bg-slate-200 dark:bg-slate-600 mx-1" />
          ...
          <div className="flex-1 flex gap-4 overflow-hidden min-h-0">
              ...
              <div className="glass-panel h-full flex flex-col overflow-hidden min-h-0">
                ...
                {!sidebarCollapsed && (
                  <>
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto p-2 scrollbar-thin">
                      {folderResult && enrichedTree ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center px-2">
                          <div className="p-3 rounded-full bg-purple-50 text-purple-600 border border-purple-100 mb-2 dark:bg-purple-900/40 dark:text-purple-200 dark:border-purple-500/40">
                            <svg
                              className="w-6 h-6"
                              fill="none"
                              viewBox="0 0 24 24"
                    ...
                    {/* Comments summary */}
                    <div className="border-t border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-900 flex flex-col h-40">
                      <div className="px-3 py-2 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <svg
                          ...
                          <span className="text-[10px] font-semibold text-slate-600 dark:text-slate-200 uppercase tracking-wider">
                            Comments
                          </span>
                        </div>
                        <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-purple-50 text-purple-700 border border-purple-100 font-medium dark:bg-purple-900/40 dark:text-purple-100 dark:border-purple-500/40">
                          ...
                          <div className="space-y-1.5">
                            {flattenedComments.map((c, idx) => (
                              <div
                                ...
                                className="p-2 rounded-md border border-slate-200 bg-white hover:border-purple-300 hover:bg-purple-50 cursor-pointer transition-colors dark:bg-slate-900 dark:border-slate-700 dark:hover:bg-slate-800 dark:hover:border-purple-500/40"
                              >
                                <div className="flex justify-between items-center mb-0.5">
                                  <span className="text-[10px] text-purple-700 dark:text-purple-300 font-medium truncate max-w-[120px]">
                                    {c.fileName}
                                  </span>
                                  <span className="text-[9px] px-1.5 py-0.5 bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-200 rounded font-mono">
                                    Ln {c.lineNumber}
                                  </span>
                                </div>
            ...
            <div className="flex-1 min-w-0 min-h-0">
              <div className="glass-panel h-full flex flex-col overflow-hidden min-h-0">
                {/* File header */}
                <div className="h-12 border-b border-slate-200 px-4 flex items-center justify-between bg-slate-50 dark:bg-slate-900 dark:border-slate-700">
                    ...
                    {selectedFile ? (
                      <>
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-slate-500 dark:text-slate-400 font-mono truncate max-w-md">
                ...
                <div className="flex-1 overflow-hidden">
                  {selectedFile ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-center px-4">
                      <div className="mb-4 p-5 rounded-full bg-purple-50 text-purple-700 border border-purple-100 dark:bg-purple-900/40 dark:text-purple-200 dark:border-purple-500/40">
                        <svg
                          className="h-12 w-12"
                          fill="none"
                          viewBox="0 0 24 24"
                      ...
                      <h3 className="text-base md:text-lg font-semibold text-slate-900 dark:text-slate-50 mb-1">
                        No file selected
                      </h3>
