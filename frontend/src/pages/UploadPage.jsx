    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        <div className="flex items-center justify-center w-9 h-9 rounded-md bg-purple-100 text-purple-700
                        dark:bg-purple-900/40 dark:text-purple-100">
          {icon}
        </div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-md border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder-slate-400
                     ...
                     disabled:dark:bg-slate-800 disabled:dark:text-slate-500"
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-md bg-purple-600 px-3 py-2.5 text-sm font-medium text-white
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-md bg-emerald-600 px-3 py-2.5 text-sm font-medium text-white
                           hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-60 disabled:cursor-not-allowed"
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-slate-500 dark:text-slate-400">
              <div className="flex items-center gap-1.5">
                <span
                  className={`inline-block h-2 w-2 rounded-full ${
                    localOld ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-600'
                  }`}
                />
              ...
              <div className="flex items-center gap-1.5">
                <span
                  className={`inline-block h-2 w-2 rounded-full ${
                    localNew ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-600'
                  }`}
                />
              ...
              <div className="flex items-center gap-1.5">
                <span
                  className={`inline-block h-2 w-2 rounded-full ${
                    localExcel ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-600'
                  }`}
                />
                <span>Excel</span>
              </div>
