    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5">
            ...
            {type === 'loading' && (
              <div className="hidden sm:flex items-center gap-1.5">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className={`w-1.5 h-1.5 rounded-full ${config.iconColor.replace(
                      'text-',
                      'bg-'
                    )} animate-bounce`}
        ...
        {(type === 'success' || type === 'info') && (
          <div className="relative mt-2 h-0.5 bg-white/40 rounded-full overflow-hidden">
            <div
